...
| 'switch' | 'toggle' | 'select' | 'checkbox' | 'autocomplete' | 'divider' | 'groupButton' | 'groupButtonFiltre' | 'custom';
...
// Основное сопоставление типа `type` → props
...
// Универсальный тип Schema, строго привязанный к type
